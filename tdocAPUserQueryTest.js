...
const tdocAPUserQueryTest = async () => {
    ...
    const tdocQueryResult = await tdocConnection.query`select * from tdoc.AP_USER where ap_unit_id=(select ap_unit_id from tdoc.ap_user where DocUserId=${user_id}) and ap_off_job='N'`
